# Generated by Django 2.2.5 on 2021-11-03 15:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_internal', models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='internal_cpty', to='swpm.Book')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='trades', to='swpm.Book')),
                ('counterparty', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='trade_set', to='swpm.Counterparty')),
            ],
        ),
        migrations.CreateModel(
            name='TradeDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_rec', models.CharField(choices=[('Recive', 1), ('Pay', -1)], max_length=6)),
                ...
                ('index', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='swpm.RateIndex')),
                ('trade', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='legs', to='swpm.IRS')),
            ],
        ),
        migrations.CreateModel(
